...
const browserStylesMap = {
    ...
    bgRedBright: 'background-color: #ff5555; color: #ffffff; padding: 2px 4px; border-radius: 3px',
    bgGreenBright: 'background-color: #55ff55; color: #000000; padding: 2px 4px; border-radius: 3px',
    bgYellowBright: 'background-color: #ffff55; color: #000000; padding: 2px 4px; border-radius: 3px',
    bgBlueBright: 'background-color: #5555ff; color: #ffffff; padding: 2px 4px; border-radius: 3px',
    bgMagentaBright: 'background-color: #ff55ff; color: #ffffff; padding: 2px 4px; border-radius: 3px',
    bgCyanBright: 'background-color: #55ffff; color: #000000; padding: 2px 4px; border-radius: 3px',
    bgWhiteBright: 'background-color: #ffffff; color: #000000; padding: 2px 4px; border-radius: 3px',
    // Text decorations
 ...
 */
export function processBrowserText(text) {
    if (isBrowser) {
 ...
 */
export function getStyledText(styles = [], text) {
    if (isBrowser) {
 ...
 */
export function logWithStyle(message, styles) {
...
export const safeNavigator = {
    ...
    getUserAgent() {
        try {
            const userAgent = safeNavigator.safeNavigatorProperty('userAgent');
    ...
    hasStorageAPI() {
        try {
            const storage = safeNavigator.safeNavigatorProperty('storage');
            return storage !== null
     ...
     */
    safeNavigatorProperty(property) {
        try {
